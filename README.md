...
2. After publishing this Managed Component as worker, follow [these steps](https://developers.cloudflare.com/workers/platform/environment-variables#add-kv-namespace-bindings-via-the-dashboard) to add a KV binding with variable name `KV`
